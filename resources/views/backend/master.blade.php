...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/')}}editor/css/summernote-bs4.min.css">
</head>
...
<body class="sb-nav-fixed">
    ...
    @yield('scripts')
    <script src="{{asset('/')}}editor/js/summernote-bs4.min.js"></script>
    <script>
        function formSubmit() {
        event.preventDefault();
        var myForm = document.getElementById('logout-form');
        myForm.submit();
    }
    </script>
